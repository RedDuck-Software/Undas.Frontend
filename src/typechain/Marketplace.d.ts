...
export type CancelBidEvent = TypedEvent<
  [BigNumber, string] & { listingId: BigNumber; seller: string }
>;

export type FinishRentalForCollateralEvent = TypedEvent<
  [BigNumber] & { rentalId: BigNumber }
>;
...
export type ListingOfferCompletedEvent = TypedEvent<
  [BigNumber, string] & { listingId: BigNumber; buyer: string }
>;
...
export type RentalEvent = TypedEvent<
  [BigNumber, string] & { rentalId: BigNumber; taker: string }
>;
...
export type StakingOfferAcceptedEvent = TypedEvent<
  [BigNumber, string] & { stakingId: BigNumber; taker: string }
>;
...
export class Marketplace extends BaseContract {
  ...
  filters: {
    ...
    "FinishRentalForCollateral(uint256)"(
      rentalId?: null
    ): TypedEventFilter<[BigNumber], { rentalId: BigNumber }>;
