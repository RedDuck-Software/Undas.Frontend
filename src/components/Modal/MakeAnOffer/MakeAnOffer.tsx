    ...
    return (
        <WindowWrap>
            ...
            <CheckoutWrap>
                ...
                <PaymentInfo>
                    <PaymentElement>
                        <Wrapper disp="flex" flexDirection="column">
                            ...
                            >
                                <CheckboxBlock>
                                <CheckboxInput type="checkbox" id="poject" name="PayInUnd" className="custom-checkbox"/>
                                <CheckboxLabel htmlFor="poject"><TextPay>Pay in <UNDIco /> with a 50% discount</TextPay></CheckboxLabel> 
                                </CheckboxBlock>
                                <Info />
                            </Wrapper>
                        </Wrapper>
                ...
                <PrivacyPolicyBlock>
                    <CheckboxBlock>
                    <CheckboxInput type="checkbox" id="purchases" name="PayInUndAg" className="custom-checkbox"/>
                    <CheckboxLabel htmlFor="purchases"> I agree to the platform{" "}
                        <ColoredTextAgreement cursor="pointer" color="#893AC2">
                            agreement ....
                        </ColoredTextAgreement></CheckboxLabel>  
                        </CheckboxBlock>        
                </PrivacyPolicyBlock>
