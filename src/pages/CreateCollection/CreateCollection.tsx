...
const CreateCollection: React.FC = () => {
  ...
  const createCollection = async (collectionName:string,collectionUrl:string,collectionInfo:string, category:number) => {
    ...
    const tx = await NFTContract.createCollection(collectionName,collectionUrl,collectionInfo,category);
      ...
      <CreateSec>
        <CreateContainer>
          ...
          <CreateForm onSubmit={handleSubmit(onSubmit)}>
            ...
            <ButtonsBlock>
              <FormButtonsWrap>
                <CreateFormButton className="left-btn" type="submit" onClick={
                    ()=>category.categoryId != undefined ?createCollection(name,customURL,information,category.categoryId):
