    ...
    return (
        <ReferralWrap>
            ...
            <PageHead>
                ...
                <TextBlock>
                the one who came through the link gets 50 und (conditionally) and a random nft on his balance, which can only be spent on paying site commissions 
                </TextBlock>
            </PageHead>
            <PageContent>
                ...
                <ContentTable>
                    ...
                    <ContentTableTr>
                        <ContentTableTd className="first-column">0x5d46cb693bd0d1585d1de9823cb6b488281cc99c</ContentTableTd>
                    ...
                    <ContentTableTr>
                        <ContentTableTd className="first-column">0x5d46cb693bd0d1585d1de9823cb6b488281cc99c</ContentTableTd>
                        <ContentTableTd><EthIco /> 40</ContentTableTd>
                        <ContentTableTd><EthIco /> 40</ContentTableTd>
                    </ContentTableTr>
                    <ContentTableTr>
                        <ContentTableTd className="first-column">0x5d46cb693bd0d1585d1de9823cb6b488281cc99c</ContentTableTd>
