...
const CreatedCollections: React.FC = () => {
    ...
    const [createdCollections,setCreatedCollections] = useState<createdCollectionItemProps[]>()
    ...
    const getCollection = async () => {
        ...
        collectionsQuery.data.collections.map((i:any) => {
            ...
            createdCollectionItems.push({id,collectionUrl,collectionCategory,collectionName,collectionInfo,owner})
        })
