...
const TabsNFT = () => {
  ...
  return ( 
    <Tabs defaultActiveKey="second" id="tab-nft" className="my-tabs">
      <Tab className="" eventKey="profile" title={<span><i className="icon-sold tab-figure"/></span>}>
      ...
      <Tab eventKey="second" title={<span><i className="profile-icon-shop tab-figure"/></span>}>
        <ReturneText>Returne #204</ReturneText>
      ...
      <Tab eventKey="third" title={<span><i className="profile-icon-handshake tab-figure"/></span>}>
        <ReturneText>Returne #204</ReturneText>
