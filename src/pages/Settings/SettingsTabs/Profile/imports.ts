...
import BannerIcon from '../../../../icons/settings-banner.png';
import { ReactComponent as SiteIco } from '../../../../icons/yoursite.svg';

export { BannerIcon, TwitterIco, SiteIco, DiscordIco, InstagramIco };
